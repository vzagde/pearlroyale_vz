    ...
    for (i = 0; i < page.query.num_records; i++) {
        ...
        if (machine_prev_details[i].date) {
            ...
            if (machine_current_details[i].date) {
                ...
                html += '<div class="col-45">'+
                            '<p class="prev_abhishek" style="margin: 10% 0"><b>'+selected_date+'</b></p>'+
                ...
                for (var i = 0; i < res.leaderboard_data.length; i++) {
                    html += '<div class="row" style="background-color: #F3F3F3">'+
                                '<div class="row leader_board" style="padding: 3% 5%;">'+
                                    ...
                                    '</div>';
                                   if (parseFloat(res.leaderboard_data[i]['num_of_patients_per_camps']) != 0) {
                                            html += '<div class="col-80">'+
                                                        '<p class="leader_txt">High Risk</p>'+
                                                    '</div>'+
                                                    '<div class="col-20">'+
                                                        '<p class="leader_no"  style="color:#A7C8BD" >'+(Number(res.leaderboard_data[i]['high_risk'])/Number(res.leaderboard_data[i]['num_of_patients_per_camps'])).toFixed(1)+'%</p>'+
                                                    '</div>';
                                        } else {
                                            html += '<div class="col-80">'+
                                                        '<p class="leader_txt">High Risk</p>'+
